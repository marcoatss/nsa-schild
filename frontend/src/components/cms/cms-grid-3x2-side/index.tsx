import { CMSGrid3x2Props } from "@/components/cms/cms-grid-3x2";
...
export interface CMSGrid3x2SideProps {
  type: "right" | "left";
  dark: boolean;
  sticky: boolean;
  fullHeight: boolean;
  paragraph: CMSTextParagraphBigProps | null;
  grid: CMSGrid3x2Props | null;
}

export const CMSGrid3x2SideComponent: React.FC<CMSGrid3x2SideProps> = ({
  type,
  dark,
  sticky,
  paragraph,
