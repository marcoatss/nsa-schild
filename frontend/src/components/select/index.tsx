...
const SelectGroupComponent = SelectPrimitive.Group;
...
SelectScrollUpButtonComponent.displayName =
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        `
          relative z-50 max-h-96 min-w-[8rem] overflow-hidden border bg-popover
...
SelectLabelComponent.displayName = SelectPrimitive.Label.displayName;
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      `
        relative flex w-full cursor-default select-none items-center px-2 py-1.5
...
SelectSeparatorComponent.displayName = SelectPrimitive.Separator.displayName;
