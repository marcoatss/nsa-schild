...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    content: Attribute.DynamicZone<
      [
        'content.grid-3x1-side',
        'content.grid-3x1',
        'content.grid-3x2-side',
        'content.grid-3x2',
        'content.grid-3x3-side',
        'content.grid-3x3',
        'content.grid-5x1',
        'content.hero'
      ]
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    models: Attribute.Component<'product.model', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    media: Attribute.Component<'product.media', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiQuoteQuote extends Schema.CollectionType {
  ...
  attributes: {
    entries: Attribute.Component<'quote.entry', true>;
    firstName: Attribute.String;
    lastName: Attribute.String;
